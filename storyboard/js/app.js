...
// escapeHtmlAttribute - AppUtils 모듈 사용 (app-utils.js가 먼저 로드됨)
const escapeHtmlAttribute = window.AppUtils.escapeHtmlAttribute;
...
// getProjectName - AppUtils 모듈 사용 (app-utils.js가 먼저 로드됨)
const getProjectName = window.AppUtils.getProjectName;
...
try {
    ...
    // convertDropboxUrl - AppUtils 모듈 사용 (app-utils.js가 먼저 로드됨)
    const convertDropboxUrl = window.AppUtils.convertDropboxUrl;
