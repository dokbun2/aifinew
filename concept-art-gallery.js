...
(function() {
    ...
    function initialize() {
        ...
        if (loadSuccess) {
            ...
            if (loadingIndicator) {
                loadingIndicator.innerHTML = '<p>컨셉아트 데이터가 없습니다.<br>먼저 컨셉아트 페이지에서 컨셉아트를 추가해주세요.</p><p style="margin-top: 20px;"><a href="your_title_storyboard_v9.4_c.html" class="header-btn">컨셉아트 페이지로 이동</a></p>';
            }
        }
